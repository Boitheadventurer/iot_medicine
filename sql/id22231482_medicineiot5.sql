...
--
-- Database: `id22231482_medicineiot5`
--
...
(1, 'yes', '21:00:00', 1, NULL, NULL, NULL, 1, 1),
...
(1, 'yes', '17:45:00', 1, 2, NULL, NULL, 1, 1),
...
(372, NULL, 1, NULL, NULL, 1, 1, NULL, NULL, NULL, 1, 'success', '2024-06-14 15:02:36', 1),
(373, NULL, NULL, 1, NULL, 1, 1, 2, NULL, NULL, 1, 'success', '2024-06-14 15:14:59', 1),
(374, NULL, NULL, NULL, 1, 1, 1, NULL, NULL, NULL, 1, 'success', '2024-06-14 16:10:16', 1),
(375, 1, NULL, NULL, NULL, 1, 1, 2, NULL, NULL, 1, 'success', '2024-06-17 10:00:41', 1),
(376, NULL, NULL, 1, NULL, 1, 1, 2, NULL, NULL, 1, 'success', '2024-06-18 16:04:20', 1),
(377, NULL, NULL, 1, NULL, 1, 1, 2, NULL, NULL, 1, 'success', '2024-06-18 17:37:23', 1),
(378, NULL, NULL, 1, NULL, 1, 1, 2, NULL, NULL, 1, 'success', '2024-06-18 17:51:14', 1);

--
-- Triggers `tb_data_eat_medicine`
--
DELIMITER $$
CREATE TRIGGER `test_time` BEFORE INSERT ON `tb_data_eat_medicine` FOR EACH ROW BEGIN
SET new.time_get = CONVERT_TZ(current_time(), '+00:00', '+07:00');
END
$$
DELIMITER ;
...
(1, 'yes', '12:00:00', 1, NULL, NULL, NULL, 1, 1),
...
(1, 'FirstName', 'LastName', 'email@gmail.com', 'bass', 'user', '2024-03-15 08:03:18', 'None'),
...
--
ALTER TABLE `tb_data_eat_medicine`
  MODIFY `data_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=379;
